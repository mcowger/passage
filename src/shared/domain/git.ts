...
export type GitStatus = GitDiscovery & { ahead: number; behind: number; aheadOfMain: number; dirty: boolean; conflicted: boolean; truncated: boolean; files: GitFileStatus[] };
