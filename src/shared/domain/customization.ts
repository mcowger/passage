...
export const BUILTIN_TOOL_RENDERERS: ToolRendererPack = {
  ...
  matchers: [
    ...
    { toolName: "web_search", displayName: "Web search", icon: "Globe", category: "search" },
    { toolName: "web_fetch", displayName: "Fetch pages", icon: "Download", category: "search" },
    { toolName: "agent_run", displayName: "Research agent", icon: "Bot", category: "agent" },
    { toolName: "get_file_contents", displayName: "GitHub file", icon: "FileCode", category: "file" },
    { toolName: "search_code", displayName: "Code search", icon: "ScanSearch", category: "search" },
    { toolName: "search_repositories", displayName: "Repo search", icon: "Package", category: "search" },
    { toolName: "actions_get", displayName: "Actions run", icon: "Activity", category: "command" },
    { toolName: "actions_list", displayName: "Actions runs", icon: "List", category: "command" },
    { toolName: "pull_request", displayName: "Pull request", icon: "GitPullRequest", category: "git" },
    { toolName: "actions_trigger", displayName: "Trigger workflow", icon: "Play", category: "command" },
    { toolName: "recall", displayName: "Recall", icon: "Brain", category: "agent" },
    { toolName: "process", displayName: "Process", icon: "Cpu", category: "command" },
  ],
};
