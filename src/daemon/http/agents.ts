...
import { type AgentService, type AgentSnapshot } from "../agents/service.ts";
...
function publicSnapshot(snapshot: AgentSnapshot): AgentSummary {
  return {
    ...
    ...(snapshot.interruptedByRestart === undefined ? {} : { interruptedByRestart: snapshot.interruptedByRestart }),
  };
}
