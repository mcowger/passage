...
export class AgentService {
  ...
  listArchived(workspaceId: string, limit = this.listLimit): AgentSnapshot[] {
    return this.views.listArchived(workspaceId, limit);
  }
