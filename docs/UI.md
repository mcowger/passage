...
| OpenChamber | Live instance study | Uniform compact rows with in-place expansion, tone-based quiet cards, status badges paired with text, header context ring, right-rail panel surfaces. |
